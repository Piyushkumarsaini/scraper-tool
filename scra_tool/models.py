...
#     extra_off = models.CharField(max_length=255, null=True, blank=True)
...
#     protect_info = models.TextField(null=True, blank=True)
#     ratings_reviews = models.CharField(max_length=255, null=True, blank=True)  # Assuming single-line summary
#     bank_offers = models.JSONField(null=True, blank=True)
#     purchase_options = models.JSONField(null=True, blank=True)
#     color_options = models.JSONField(null=True, blank=True)
#     storag_options = models.JSONField(null=True, blank=True)
#     ram_options = models.JSONField(null=True, blank=True)
#     delivery_date = models.CharField(max_length=100, null=True, blank=True)
#     delivery_note = models.TextField(null=True, blank=True)
#     payment_offers = models.JSONField(null=True, blank=True)
#     highlight_items = models.JSONField(null=True, blank=True)
